            ...
            <nav class="navbar navbar-default">
              ...
              <div class="collapse navbar-collapse main-menu bs-example-navbar-collapse-1" id="navbar-example">
                <ul class="nav navbar-nav navbar-right">
                  <li class="active">
                    <a class="page-scroll" href="stud_index.php">Home</a>
                  </li>
                 <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Course<span class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu">
					
                      <li><a href="stud_offline.php">offline</a></li>
                                <li class="dropdown-submenu">
        <a class="test" tabindex="-1" href="stud_online.php">online<span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a tabindex="-1" href="stud_online.php">Solve Doubt</a></li>
          <li><a tabindex="-1" href="lives.html">Live Stream</a></li>                  
        </ul>
      </li>
    </ul> 
