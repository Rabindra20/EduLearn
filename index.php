  ...
  <header>
    ...
    <div id="sticker" class="header-area">
      <div class="container">
        ...
        <a class="test" tabindex="-1" href="#">online<span class="caret"></span></a>
        <ul class="dropdown-menu">
          <li><a tabindex="-1" href="#">Solve Doubt</a></li>
          <li><a tabindex="-1" href="#" echo="login">Go Live</a></li>                  
        </ul>
      </li>
    </ul> 
                  <li>
                  ...
                  <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Login/Register<span class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu">
